...
class TestSolve:
    ...
    def test_sonic_minimise_default(self, tmpdir):
        solve(
            output_dir=Path(str(tmpdir)), sonic_method="sonic_minimise",
            config_file=None, output_file=None, store_internal=True,
        )

    def test_sonic_minimise_no_internal(self, tmpdir):
        solve(
            output_dir=Path(str(tmpdir)), sonic_method="sonic_minimise",
            config_file=None, output_file=None, store_internal=False,
        )
...
class TestReSolve:
    ...
    def test_sonic_minimise_default(self, tmpdir, solution):
        resolve(
            output_dir=Path(str(tmpdir)), sonic_method="sonic_minimise",
            soln_filename=solution, soln_range=None, output_file=None, store_internal=True,
        )

    def test_sonic_minimise_no_internal(self, tmpdir, solution):
        resolve(
            output_dir=Path(str(tmpdir)), sonic_method="sonic_minimise",
            soln_filename=solution, soln_range=None, output_file=None, store_internal=False,
        )
