...
def jacobian_viewer_generator(internal_data):
    ...
    if internal_data is not None:
        jaclist = internal_data.jacobians.jacobians
        anglelist = internal_data.jacobians.angles
        paramlist = internal_data.jacobians.params
        derivlist = internal_data.jacobians.derivs
